...
SECRET_KEY = 'ndon=54-t$e&b*hfq%*zkx*7v@(ry18lh9(ap3vtgk@uu6n06+'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tv_shows', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
